...
![Architecture](assets/citc-cloudfront-architecture.png)
...
```text
assets/
├── citc-cloudfront-architecture.png
├── s3-static-site.png
├── acm-request.png
├── acm-issued.png
...
➡️ [Phase 5 - Monitoring, Alerts & Architecture Visibility](05.Phase5-visibility.md)
